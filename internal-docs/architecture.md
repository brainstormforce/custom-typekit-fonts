# Architecture — Custom Adobe Fonts (Typekit)

## Overview

Custom Adobe Fonts (Typekit) is a WordPress plugin that follows standard WordPress plugin architecture patterns.

## Entry Point

The plugin entry point is `custom-typekit-fonts.php`, which:
...
1. WordPress loads the plugin via `custom-typekit-fonts.php`
